...
;hljs.registerLanguage("typescript",e)})();/*! `haskell` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
...
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}}})();hljs.registerLanguage("d",e)})();/*! `vbnet` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("dockerfile",e)})();/*! `diff` grammar compiled for Highlight.js 11.7.0 */
...
})();hljs.registerLanguage("pgsql",E)})();/*! `c` grammar compiled for Highlight.js 11.7.0 */
